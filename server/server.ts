...
const LOCATOR_METHODS: CompletionItem[] = [
    ...
    { label: "getByLabel", kind: CompletionItemKind.Method, detail: "Get by label", documentation: "Returns locator by label." },
    { label: "getByPlaceholder", kind: CompletionItemKind.Method, detail: "Get by placeholder", documentation: "Returns locator by placeholder text." },
    { label: "getByAltText", kind: CompletionItemKind.Method, detail: "Get by alt text", documentation: "Returns locator by alt text." },
    { label: "getByTitle", kind: CompletionItemKind.Method, detail: "Get by title", documentation: "Returns locator by title." },
    { label: "getByTestId", kind: CompletionItemKind.Method, detail: "Get by test id", documentation: "Returns locator by test id." }
];
